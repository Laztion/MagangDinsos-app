    ...
    <div class="auth-container" data-aos="fade-up">
        ...
        <div class="auth-card auth-card-reverse">
            ...
            <div class="auth-form-side">
                ...
                <div class="auth-form-inner" data-aos="fade-right" data-aos-delay="100">
            ...
            <div class="auth-banner auth-banner-teal">
                ...
                <div class="auth-banner-header" style="justify-content: flex-end;" data-aos="fade-down">
                ...
                <div class="auth-banner-title" data-aos="fade-left" data-aos-delay="100" style="margin-top: auto; margin-bottom: auto;">
                    <h1>
                        Bangun <br/>
                        Masa Depan <br/>
